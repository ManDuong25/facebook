...
const PostManagementPage = () => {
    ...
    const handleToggleVisibility = async (post) => {
        ...
        try {
            ...
            if (response.status === 'success') {
                // Cập nhật state
                setPosts(posts.map((p) => (p.id === post.id ? { ...p, visible: !p.visible } : p)));
            ...
            {showPostDetail ? (
                <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button onClick={handleClosePostDetail} className="text-gray-500 hover:text-gray-700">
                    ...
                    <div className="mb-4 pb-4 border-b">
                        ...
                        <p className="text-gray-800 whitespace-pre-line mb-3">{selectedPost?.content}</p>
                        ...
                        <div className="flex items-center text-sm text-gray-500 space-x-4">
                            <span>
                                <i className="bi bi-hand-thumbs-up mr-1"></i> {likeCount} lượt thích
                            </span>
                            <span>
                                <i className="bi bi-chat mr-1"></i> {commentCount} bình luận
                            </span>
                            <span>
                                <i className="bi bi-share mr-1"></i> {shareCount} chia sẻ
                            </span>
                            {selectedPost?.visible === false && (
                                <span className="text-red-500">
                                    <i className="bi bi-eye-slash mr-1"></i> Đã ẩn
                                </span>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between">
                        <div>
                            ...
                            >
                                <i
                                    className={`bi ${selectedPost?.visible === false ? 'bi-eye' : 'bi-eye-slash'} mr-2`}
                                ></i>
