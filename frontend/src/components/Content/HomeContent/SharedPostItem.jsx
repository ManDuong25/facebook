...
import { likePost, unlikePost, addComment, getComments, sharePost, getLikeStatus, getShares } from "../../../services/api";
...
const SharedPostItem = ({ share }) => {
  ...
  const formattedDate = sharedAt 
    ? formatDistanceToNow(new Date(sharedAt), { addSuffix: true, locale: vi })
    : "";
