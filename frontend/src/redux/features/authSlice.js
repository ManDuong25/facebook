...
const validateUserData = (userData) => {
  ...
  if (user.avatar && (user.avatar === 'avatar1.png' || user.avatar === 'avatar2.png' || 
      user.avatar === 'avatar3.png' || user.avatar === 'avatar4.png' ||
      user.avatar === '/avatar1.png' || user.avatar === '/avatar2.png' || 
      user.avatar === '/avatar3.png' || user.avatar === '/avatar4.png')) {
    console.log('Replacing fake avatar path in Redux:', user.avatar);
