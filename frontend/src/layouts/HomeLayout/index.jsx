    ...
    return (
        <div className="min-h-screen flex flex-col overflow-y-auto">
            ...
            <div className="flex flex-1 pt-14">
                {/* Cột trái - Sidebar */}
                <div
                    className={`hidden lg:block lg:w-1/4 bg-gray-100 fixed top-14 bottom-0 overflow-y-auto ${styles['scrollbar-custom']} ${styles['sidebar']}`}
                >
                    <LeftSidebar />
                </div>
                {/* Cột giữa - Feed */}
                ...
                <div
                    ...
                    className={`hidden lg:block lg:w-1/4 bg-gray-100 fixed top-14 right-0 bottom-0 overflow-y-auto ${styles['scrollbar-custom']} ${styles['sidebar']}`}
                >
                    <RightSidebar />
                </div>
            </div>
